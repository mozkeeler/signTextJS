...
function loadLibraries() {
  ...
  SECITEM_FreeItem = declareFunction("SECITEM_FreeItem", nss3,
                                     [ctypes.void_t,
                                      SECItem.ptr,
                                      ctypes.bool]);
  SEC_PKCS7CreateSignedData = declareFunction("SEC_PKCS7CreateSignedData", smime3,
                                              [SEC_PKCS7ContentInfo,
                                               ...
                                               ctypes.voidptr_t,
                                               ctypes.voidptr_t]);
  SEC_PKCS7IncludeCertChain = declareFunction("SEC_PKCS7IncludeCertChain", smime3,
                                              [SECStatus,
                                               SEC_PKCS7ContentInfo,
                                               ctypes.voidptr_t]);
  ...
  SEC_PKCS7Encode = declareFunction("SEC_PKCS7Encode", smime3,
                                        [SECStatus,
                                         ...
                                         ctypes.voidptr_t,
                                         ctypes.voidptr_t]);
  SEC_PKCS7DestroyContentInfo = declareFunction("SEC_PKCS7DestroyContentInfo", smime3,
                                                [ctypes.void_t,
                                                 SEC_PKCS7ContentInfo]);
}
